...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { is_done: @assignment.is_done, task_id: @assignment.task_id, user_id: @assignment.user_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { is_done: @assignment.is_done, task_id: @assignment.task_id, user_id: @assignment.user_id } }
